#############################################################################
# Makefile for building: speechbubble
# Generated by qmake (2.01a) (Qt 4.8.4) on: su marraskuuta 10 15:19:05 2013
# Project:  speechbubble.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile speechbubble.pro
#############################################################################
...
Makefile: speechbubble.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile speechbubble.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/speechbubble1.0.0 || $(MKDIR) build/speechbubble1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/speechbubble1.0.0/ && $(COPY_FILE) --parents src/channel.h src/commands.h src/config.h src/connection.h src/context.h src/crashcatcher.h src/format.h src/macros.h src/main.h src/mainwindow.h src/user.h src/xml.h src/xml_scanner.h build/speechbubble1.0.0/ && $(COPY_FILE) --parents src/channel.cc src/commands.cc src/config.cc src/connection.cc src/context.cc src/crashcatcher.cc src/format.cc src/main.cc src/mainwindow.cc src/user.cc src/xml.cc src/xml_scanner.cc build/speechbubble1.0.0/ && $(COPY_FILE) --parents ui/bombbox.ui ui/connectTo.ui ui/main.ui build/speechbubble1.0.0/ && (cd `dirname build/speechbubble1.0.0` && $(TAR) speechbubble1.0.0.tar speechbubble1.0.0 && $(COMPRESS) speechbubble1.0.0.tar) && $(MOVE) `dirname build/speechbubble1.0.0`/speechbubble1.0.0.tar.gz . && $(DEL_FILE) -r build/speechbubble1.0.0
